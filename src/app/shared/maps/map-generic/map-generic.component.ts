...
export class MapGenericComponent implements OnInit {
  ...
  constructor( private mapSvgLoaderService: MapSvgLoaderService, private mapDataLoaderService: MapDataLoaderService) { }
  ...
  private loadMapSvg(mapIdentifier: string) {
    ...
    this.mapSvgLoaderService.getMapSvg(mapIdentifier).subscribe(svg => {
      this.loadedMap = svg;
  ...
  private loadMapData(mapIdentifier: string) {
    this.mapDataLoaderService.getMapMetaData(mapIdentifier).subscribe(data => {
