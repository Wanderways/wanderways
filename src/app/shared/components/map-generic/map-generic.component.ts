...
export class MapGenericComponent implements OnInit {
  ...
  ngOnChanges(changes: SimpleChanges) {
    ...
    if (changes.currentSelected) if (changes.currentSelected.currentValue !== undefined) this.areaClick((changes.currentSelected.currentValue as MapData).identifier);
  }
  ...
  canCurrentSelectedBeDisplayed(mapData: MapData | undefined) {
    ...
    if (this.foundList.find(e=>e.identifier === mapData.identifier)) return true;
    return false;
  }
}
